...
class XenForo_Application extends Zend_Registry
{
	...
	public static $versionId = 1050870; // abbccde = a.b.c d (alpha: 1, beta: 3, RC: 5, stable: 7, PL: 9) e
	...
	*/
	public function loadDefaultConfig()
	{
		return new Zend_Config(array(
			...
			'superAdmins' => '1',
			'globalSalt' => 'Diễn đàn Xenforo Việt Nam | Forums Xenforo Vietnam | VNXF.VN ',
			'jsVersion' => '',
			'cookie' => array(
				'prefix' => 'xf_',
				'path' => '/',
	...
	*/
	...
	{
		return '<a href="https://xenforo.com" class="concealed">Forum software by XenForo&trade; <span>&copy;2010-2016 XenForo Ltd.</span></a>';
	}
